...
@section('title')
    <title>AR | Periodo</title>
@endsection

@section('content')
    <div class="card">
        <div class="card-header">
            <h2 class="card-title">Mantenimiento <b> Académico</b></h2>
        </div>
        <div class="card-body">
                ...
                <div class="nav-align-top mb-4">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="navs-pills-top-home" role="tabpanel">
                            ...
                            <table id="tabla-periodo" class="table table-bordered table-hover">
                                <thead class="table-dark">
                                    <tr>
                                        <th data-priority="1" class="text-center">ID</th>
                                        <th data-priority="2" class="text-center">Periodo Académico</th>
                                        <th data-priority="2" class="text-center"># Semestres</th>
                        ...
                        <div class="tab-pane fade" id="navs-pills-top-profile" role="tabpanel">
                            <form id="registro-periodo">
                                @csrf
                                <div class="row">
                                    <div class="mb-3 col-md-12">
                                        <label class="form-label" for="curso_nombre">Periodo Académico</label>
                                        <input type="text" class="form-control" id="peri_descripcion"
                                            name="peri_descripcion" placeholder="Periodo académico">
                                    </div>
                                    <div class="mb-3 col-md-12">
                                        <label class="form-label" for="curso_nombre">Número de semestres</label>
                                        <input type="number" class="form-control" id="nro_semestre" name="nro_semestre"
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        <div class="mb-3 col-md-12">
                                            <label class="form-label" for="curso_nombre">Periodo Académico</label>
                                            <input type="text" class="form-control" id="update_peri_descripcion"
                                                name="peri_descripcion" placeholder="Periodo académico">
                                        </div>
                                    </div>
...
@section('css')
    ...
    <style>
        #tabla-periodo thead th {
            text-align: center;
            color: white;
        }

        #tabla-periodo tbody td:eq(0) {
            text-align: left;
        }

        #tabla-periodo tbody td {
            text-align: center;
            color: dark;
        }
...
@section('js')
    ...
    {{-- CREAR --}}
    <script>
        $('#registro-periodo').submit(function(e) {
            e.preventDefault();
            ...
            $.ajax({
                ...
                type: "POST",
                dataType: 'json',
                data: new FormData($("#registro-periodo")[0]),
                contentType: false,
                processData: false,
                beforeSend: function() {
